...
| 题目 | [第一场 ( 7/12)](https://ac.nowcoder.com/acm/contest/120561) | [第二场 ( 6/10)](https://ac.nowcoder.com/acm/contest/120562) | [第三场 ( 7/10)](https://ac.nowcoder.com/acm/contest/120563) | [第四场 ( 7/10)](https://ac.nowcoder.com/acm/contest/120564) | [第五场 ( 6/10)](https://ac.nowcoder.com/acm/contest/120565) | 第六场 |
| ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------ |
| A    | 状压、枚举、概率、逆元                                       | 简单思维                                                     | 枚举、简单数学                                               | 签到、枚举                                                   | **二进制、二分、lowbit、注意力题**                           |        |
| B    | 贪心、思维、数学                                             | 排序、贪心                                                   | 暴力、概率、gcd                                              | 前缀和                                                       | 签到                                                         |        |
| C    | 贪心、脑筋急转弯                                             | **搜索、二分**                                               | 构造、前缀和、Kadane                                         | 构造、位运算、格雷码、分治                                   | **几何、二分，线段覆盖**                                     |        |
| D    | **二分、贪心**                                               | **树形 DP、数学**                                            | **网格 BFS、最短路**                                         | **数学、扩展欧几里得（EXGCD）、二分**                        | **贪心、排序、双端队列**                                     |        |
| E    | 枚举、贪心                                                   | 构造                                                         | **最小生成树、Kruskal**                                      | **状压DP、路径还原、打表**                                   | 贪心、二分，数据结构                                         |        |
| F    | **组合数学、链式并查集**                                     | 数论、位运算                                                 | 博弈、最短路、构造                                           | 构造                                                         | 贪心、暴力，背包                                             |        |
| G    | 分类讨论、枚举、贪心                                         | **数据结构、平衡树**                                         | 贪心、排序、前缀和                                           | 数学、打表、质因数、搜索                                     | 模拟                                                         |        |
| H    | **位运算、前缀和、优化 DP**                                  | 计数、容斥                                                   | 解析几何、三角形面积                                         | STL、暴力                                                    | **棋盘染色、贪心**                                           |        |
| I    | **贪心、位运算、构造**                                       | 思维                                                         | **位运算  (XOR)、线性基**                                    | 概率、期望、诈骗                                             | 二分、前缀和差分                                             |        |
| J    | **最小生成树、线段树**                                       | **图论、BFS、最短路**                                        | 完全二叉树编号、位运算                                       | **最短路、路径还原、模拟**                                   | 签到                                                         |        |
| K    | 签到、构造                                                   | (未列出)                                                     | (未列出)                                                     | (未列出)                                                     | (未列出)                                                     |        |
| L    | 签到、语法题                                                 |                                                              |                                                              |                                                              |                                                              |        |
